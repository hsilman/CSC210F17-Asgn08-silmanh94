package com.harrysilman.roadsignquiz;
...
public class MainActivityFragment extends Fragment {
    ...
    private List<String> quizSignsList; // countries in current quiz
    ...
    public void resetQuiz() {
        ...
        try {
            String[] files = assets.list("Signs");
        ...
        quizSignsList.clear(); // clear prior list of quiz flags
    ...
    private void loadNextSign() {
        ...
        try (InputStream stream =
                     assets.open("Signs/" + nextImage + ".png")) {
    ...
    // parses the sign file name and returns the sign's name
